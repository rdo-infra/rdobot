...
# This script is a handler meant to accept data from Sensu as stdin in order to
# post events to Errbot.
# The configuration files to use this script are found in the same directory.
